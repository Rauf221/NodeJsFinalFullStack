...
const AutumnCollections: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4">
     ...
     <h2 className="text-4xl font-semibold text-center mb-4">Autumn Collection</h2>
     <span className= "h-[1px] bg-gray-200 w-[150px]"> </span>
     </div>
     
      <p className="text-center text-xl mb-8">Collect your loves with our autumn arrivals.</p>
...
export default AutumnCollections;
