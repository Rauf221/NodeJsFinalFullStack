...
import CartSidebar from "@/components/Sidebar/CardSidebar";
import LoginModal from "@/components/modal/LoginRegister";
      ...
      <nav className="bg-white shadow-sm border-b ">
        <div className="container mx-auto flex justify-between items-center py-4 px-5">
          ...
          <div className="pl-40 flex space-x-6 items-center">
              ...
              <FiUser className="text-2xl cursor-pointer" onClick={toggleModal} />
            )}
